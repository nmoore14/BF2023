import { reactive, getCurrentInstance, version, toRef, isRef, inject, nextTick, shallowRef, computed, isReadonly, defineComponent, ref, h, resolveComponent, mergeProps, withCtx, createVNode, createTextVNode, useSSRContext, Suspense, Transition, provide, onErrorCaptured, onServerPrefetch, unref, defineAsyncComponent, createApp } from "vue";
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-b943366b.js").then((m) => m.default || m)
  },
  {
    name: "forum",
    path: "/forum",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-d2db0b13.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-5a136dc5.js").then((m) => m.default || m)
  },
  {
    name: "loginRegister",
    path: "/loginRegister",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-99d3375b.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/BarbaraJohnston-5807eb2c.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/CharlesReed-3b562877.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/DavidHubbard-39c2191b.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/JeffDavis-1d750320.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/JoeCraft-8a55e495.js").then((m) => m.default || m)
  },
  {
    name: "speakers",
    path: "/speakers",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-ee78f644.js").then((m) => m.default || m)
  }
];
...
const Navbar_vue_vue_type_style_index_0_scoped_7a786165_lang = "";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div><div class="footer-right"><ul class="flex row wrap w-full justify-center items-center"><li class="footer-list-item">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "link-item",
    to: "/forum"
  }, {
  ...
  _push(`</li><li class="footer-list-item">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "link-item",
    to: "/speakers"
  }, {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-70f37bbd.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-d2364c4c.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
