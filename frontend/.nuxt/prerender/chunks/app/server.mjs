import { getCurrentInstance, version, useSSRContext, defineComponent, computed, ref, h, resolveComponent, shallowRef, reactive, isReadonly, mergeProps, createApp, effectScope, markRaw, toRef, isRef, nextTick, Suspense, Transition, provide, onErrorCaptured, onServerPrefetch, unref, inject, withCtx, createVNode, createTextVNode, defineAsyncComponent } from 'file:///Users/nickmoore_rush/Desktop/projects/school/bf2023/frontend/node_modules/.pnpm/vue@3.2.47/node_modules/vue/index.mjs';
...
import { hasProtocol, isEqual, parseURL, joinURL } from 'file:///Users/nickmoore_rush/Desktop/projects/school/bf2023/frontend/node_modules/.pnpm/ufo@1.1.0/node_modules/ufo/dist/index.mjs';
...
const inlineConfig = {};
defuFn(inlineConfig);
const plugin_vue3_0kzQ6Jz8v8 = defineNuxtPlugin((nuxtApp) => {
...
const vueuse_head_plugin_0ca354AQ2b = defineNuxtPlugin((nuxtApp) => {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5aec5fd3.mjs').then((m) => m.default || m)
  },
  {
    name: "forum",
    path: "/forum",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ce15add5.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-04c59231.mjs').then((m) => m.default || m)
  },
  {
    name: "loginRegister",
    path: "/loginRegister",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-e12e4628.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/BarbaraJohnston-66a581d6.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/CharlesReed-4532b902.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/DavidHubbard-50f77d89.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/JeffDavis-dece083a.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/JoeCraft-94634d17.mjs').then((m) => m.default || m)
  },
  {
    name: "speakers",
    path: "/speakers",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-9df3fa18.mjs').then((m) => m.default || m)
  }
];
...
const router_bznahFOT4M = defineNuxtPlugin(async (nuxtApp) => {
  var _a, _b;
  let __temp, __restore;
...
const _plugins = [
  plugin_vue3_0kzQ6Jz8v8,
  components_plugin_KR1HBZs4kY,
  vueuse_head_plugin_0ca354AQ2b,
  router_bznahFOT4M
];
const _sfc_main$3 = {
  setup() {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-57a23a35.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-1ffdd64a.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.2.2_eslint@8.36.0+sass@1.58.3/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, _imports_0 as a, useRequestFetch as b, createError as c, __nuxt_component_0$1 as d, entry$1 as default, useNuxtApp as u };
